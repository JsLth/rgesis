...
[rgesis](https://github.com/jslth/rgesis/) provides a simple,
programmatic and reproducible interface to the GESIS search engine and
data archive. It allows the retrieval of metadata on records like
...
[rgesis](https://github.com/jslth/rgesis/) takes over continuous
credentials management and OAuth authentication using the
[`{keyring}`](https://keyring.r-lib.org/) and
...
[rgesis](https://github.com/jslth/rgesis/) can be used to search for
research data
